...
2. Set the colors in the COLORS section of the `src/styles/_variables.scss` file. Add colours for slice variations and for header, mobile nav and footer. You may only add variation set
   variables. You may NOT add more than that.
4. In the `src/components/layout/Header/Header.module.scss` and `.../MobileHeader.module.scss` and
   `.../NavigationMobile.module.scss` files set the font family for the links if it is not what is currently set.
